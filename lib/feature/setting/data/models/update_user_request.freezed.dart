...
mixin _$UpdateUserRequest {
 ...
 String? get nickName; String? get dormitory; List<String> get routines;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateUserRequest&&(identical(other.nickName, nickName) || other.nickName == nickName)&&(identical(other.dormitory, dormitory) || other.dormitory == dormitory)&&const DeepCollectionEquality().equals(other.routines, routines));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,nickName,dormitory,const DeepCollectionEquality().hash(routines));

@override
String toString() {
  return 'UpdateUserRequest(nickName: $nickName, dormitory: $dormitory, routines: $routines)';
}
...
@useResult
$Res call({
 String? nickName, String? dormitory, List<String> routines
});
...
/// Create a copy of UpdateUserRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nickName = freezed,Object? dormitory = freezed,Object? routines = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? nickName,  String? dormitory,  List<String> routines)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateUserRequest() when $default != null:
return $default(_that.nickName,_that.dormitory,_that.routines);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? nickName,  String? dormitory,  List<String> routines)  $default,) {final _that = this;
switch (_that) {
case _UpdateUserRequest():
return $default(_that.nickName,_that.dormitory,_that.routines);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? nickName,  String? dormitory,  List<String> routines)?  $default,) {final _that = this;
switch (_that) {
case _UpdateUserRequest() when $default != null:
return $default(_that.nickName,_that.dormitory,_that.routines);case _:
  return null;
...
class _UpdateUserRequest implements UpdateUserRequest {
  const _UpdateUserRequest({required this.nickName, required this.dormitory, required final  List<String> routines}): _routines = routines;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UpdateUserRequest&&(identical(other.nickName, nickName) || other.nickName == nickName)&&(identical(other.dormitory, dormitory) || other.dormitory == dormitory)&&const DeepCollectionEquality().equals(other._routines, _routines));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,nickName,dormitory,const DeepCollectionEquality().hash(_routines));
...
/// Create a copy of UpdateUserRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nickName = freezed,Object? dormitory = freezed,Object? routines = null,}) {
